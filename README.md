...
Desafio proposto pela NeoAssist, como forma de avaliação técnica dos candidatos à vaga de **Programador Backend**, neste caso para a vaga de *Pessoa Programadora PHP*.
...
As seguintes intruções também foram dadas: 
